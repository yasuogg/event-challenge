...
export default function login() {
  return (
    ...
    <input className=' focus:border-blue-500 duration-500 shadow appearance-none border-2 rounded w-40% text-2xl lg:text-3xl py-3 px-3  text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:text-[#0053B5] rounded-full'/>
    </div>
    <div className='flex-col p-1'>
    <label className='flex p-2'>Password</label>
    <input type='password' className=' focus:border-blue-500 duration-500 shadow appearance-none border-2 rounded text-2xl lg:text-3xl w-50% py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:text-[#0053B5] rounded-full'/>
    </div>
    </div>
